...
var lib = require('node-gyp-build')((0, path_1.join)(__dirname, '..'));
var KeyToggle;
(function (KeyToggle) {
...
var UiohookNapi = /** @class */ (function (_super) {
    __extends(UiohookNapi, _super);
    ...
    UiohookNapi.prototype.keyTap = function (key, modifiers) {
    ...
    UiohookNapi.prototype.keyToggle = function (key, toggle) {
